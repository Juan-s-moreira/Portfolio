      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {projects.map((project) => (
            <div className="card bg-gray-800/50 backdrop:blur-sm border-2 border-gray-700 hover:border-purple-500 transition-all duration-400 overflow-hidden" key={project.id}>
