...
//           <div className="card bg-gray-800/80 backdrop-blur-sm border-gray-700">
...
//                   "MongoDB",
//                 ].map((skill) => (
//                   <span key={skill} className="px-4 py-3 badge badge-lg bg-gray-700/80 backdrop-blur-sm text-gray-300 rounded-full text-sm border border-gray-600 hover:border-purple-500 hover:text-purple-400 transition-colors cursor-default">
//                     {skill}
