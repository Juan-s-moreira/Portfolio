        ...
        <div className="max-w-6xl mx-auto relative z-10 flex flex-col-reverse md:flex-row items-center justify-between gap-12 w-full">
            ...
            <div className="w-full md:w-3/5 flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-10 w-full sm:w-auto">
                    <a href="#projects" className="px-8 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition-all duration-300 hover:shadow-[0_0_20px_rgba(147,51,234,0.4)] hover:-translate-y-1 text-center">
                        {language === 'pt' ? 'Ver Projetos' : 'View Projects'}
                    </a>
                    <a href="#contact" className="px-8 py-3 bg-transparent border border-purple-500 text-purple-400 hover:bg-purple-900/30 rounded-lg font-semibold transition-all duration-300 hover:-translate-y-1 text-center">
            ...
            <div className="w-full md:w-2/5 flex justify-center md:justify-end relative">   
                <div className="relative w-[250px] h-[250px] md:w-[320px] md:h-[320px] rounded-full p-2 border-2 group">
                    <img 
                        src="./src/assets/JUAN-SANTOS-2.jpg" 
                        alt={t.hero.name} 
